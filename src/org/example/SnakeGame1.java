...
public class SnakeGame1{  // One or two player
    ...
    public void StartGame(){
        ...
        System.out.println("===========================================");
        System.out.println("I am Teletubbies and i will be player (A)"); 
        String A = "Teletubbies";
        ...
        while (playerA.getposition() < 100 && playerB.getposition() < 100) {
            ...
            int num = 0;
            if (players.first().getPlayerName().equals(B)) {
                System.out.println(B + " enter 'R' to roll the dice");
                String roll = scan.nextLine();
                if (roll.equalsIgnoreCase("R")) {
                    num = rollDice();
                    System.out.println("Your roll dice " + num);
                } else {
                    System.out.println("Invalid input. Enter 'R' to roll the dice.");
                 
                }
            } else {
                num = rollDice();
                System.out.println(A + " your roll dice " + num); 
            }
